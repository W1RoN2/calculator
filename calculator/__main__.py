...
class Main(Frame):
    ...
    def build(self):
        self.formula = "0"
        self.lbl = Label(text=self.formula, font=("Times New Roman", 21, "bold"), bg="#333333", foreground="#FFF")
    ...
    def logicalc(self, operation):
        if operation == "C":
            ...
            self.formula = str(eval(self.formula) & 0xFFFFFFFF)
        elif operation == "|":
            self.formula = str(eval(self.formula) | 0xFFFFFFFF)
        else:
            if self.formula == "0":
